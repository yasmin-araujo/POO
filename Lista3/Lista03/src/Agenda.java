...
public class Agenda
{
    ...
    public void addContato(String CPF, String nome, String endereco, String data_nasc, String email, String estado_civil)
    {
        Pessoa p = new PessoaFisica(CPF, nome, endereco, data_nasc, email, estado_civil);
        pessoas.add(p);
    }

    public void addContato(String CNPJ, String nome, String endereco, String email, int inscricao_estadual, String razao_social)
    {
    ...
    public void ordenaContatos()
    {
        ...
        pessoas.sort( (p1, p2) -> {
            ...
            if(p1 instanceof PessoaJuridica && p2 instanceof PessoaJuridica)
                return Long.valueOf(((PessoaJuridica) p1).getCNPJ()) > Long.valueOf(((PessoaJuridica) p2).getCNPJ()) ? 1 : -1;
