...
public class Random
{
    ...
    private long p = 2147483648L; // uso do L - num extrapola tamanho max do inteiro - se não extrapola -> nao
    // precisa, como nao tem perda de valor nao precisa do cast
    ...
    public double getRand()
    {
        ...
        xi = (a + m * xi) % p;
        double d = Math.abs(xi); //promove p/ double garantindo que será um número positivo
        return d / p;
    }
